...
if (!fs.existsSync(DB_PATH)) {
  console.log('⚠️  Base de datos no encontrada. Creando automáticamente...');
  require('child_process').execSync('node ' + path.join(__dirname, '..', 'scripts', 'setup-db.js'), { stdio: 'inherit' });
}
